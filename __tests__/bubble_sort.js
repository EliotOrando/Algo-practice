...
describe("bubble sort tests:", () => {
  it("should return empty array", () => {
    expect(bubble_sort([])).toBe([]);
  });
  it("should return single character", () => {
    expect(bubble_sort([1])).toBe([1]);
  });
  it("should return sorted array", () => {
    expect(bubble_sort([8, 5, 2, 9, 5, 6, 3])).toBe([2, 3, 5, 5, 6, 8, 9]);
    expect(bubble_sort([2, 1])).toBe([1, 2]);
    expect(bubble_sort([1, 3, 2])).toBe([1, 2, 3]);
    expect(
      bubble_sort([
    ...
    ).toBe([-10, -10, -9, -7, -7, -6, -5, -2, 2, 2, 3, 3, 4, 5, 8, 8, 9, 10]);
    expect(
      bubble_sort([
