...
Make sure to run <code>npm i</code> to install jest as a dev dependnecy. And then you can run tests with npm run test ${test-name} example: <code>npm run test two_sum</code>
